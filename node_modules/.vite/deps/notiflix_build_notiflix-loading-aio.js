...
var require_notiflix_loading_aio = __commonJS({
  "node_modules/notiflix/build/notiflix-loading-aio.js"(exports, module) {
    (function(root, factory) {
      ...
      var loadingCreate = function(loadingType, messageOrOptions, options, display, delay) {
        ...
        if (display) {
          ...
          var winWidth = window2.innerWidth;
          ...
          var ntflxLoadingWrap = window2.document.createElement("div");
          ...
          if (!window2.document.getElementById(ntflxLoadingWrap.id)) {
            window2.document.body.appendChild(ntflxLoadingWrap);
            if (newLoadingSettings.clickToClose) {
              var loadingWrapElm = window2.document.getElementById(ntflxLoadingWrap.id);
          ...
          if (window2.document.getElementById(loadingSettings.ID)) {
            var loadingElm = window2.document.getElementById(loadingSettings.ID);
      ...
      var loadingChangeMessage = function(newMessage) {
        ...
        var messageWrap = window2.document.getElementById(loadingSettings.ID);
        if (messageWrap) {
          if (newMessage.length > 0) {
            ...
            if (oldMessageElm) {
              oldMessageElm.innerHTML = newMessage;
            } else {
              var newMessageHTML = window2.document.createElement("p");
      ...
      var Notiflix = {
        Loading: {
          ...
          standard: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Standard, messageOrOptions, options, true, 0);
          },
          // Hourglass
          hourglass: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Hourglass, messageOrOptions, options, true, 0);
          },
          // Circle
          circle: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Circle, messageOrOptions, options, true, 0);
          },
          // Arrows
          arrows: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Arrows, messageOrOptions, options, true, 0);
          },
          // Dots
          dots: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Dots, messageOrOptions, options, true, 0);
          },
          // Pulse
          pulse: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Pulse, messageOrOptions, options, true, 0);
          },
          // Custom
          custom: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Custom, messageOrOptions, options, true, 0);
          },
          // Notiflix
          notiflix: function(messageOrOptions, options) {
            loadingCreate(typesLoading.Notiflix, messageOrOptions, options, true, 0);
          },
          // Remove
          remove: function(delay) {
            ...
            loadingCreate(null, null, null, false, delay);
          },
          // Change The Message
      ...
      if (typeof window2.Notiflix === "object") {
        return commonExtendOptions(true, window2.Notiflix, { Loading: Notiflix.Loading });
      } else {
...
export default require_notiflix_loading_aio();
//# sourceMappingURL=notiflix_build_notiflix-loading-aio.js.map
